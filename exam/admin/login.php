...
<html lang="en">
  <head>
    ...
    <title>Online Exam | Admin Area</title>
				   ...
				   <div class="member-col member-left">
					   ...
					   <div class="member-col-inner">
						   ...
						   <span><?php if(isset($adminData))
							   ...
							   <p>Please provide the User Name and Password</p>
							   ...
							   <input type="text" class="form-control" placeholder="Enter email to join">
							   <a href="#" class="btn btn-blue btn-block">Sign Up for ATech Exam</a>
