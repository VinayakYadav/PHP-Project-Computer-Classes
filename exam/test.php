                	...
                	<div class="q-timer-bar">
                    	<div class="row">
                            ...
                            <div class="col-sm-6 mb-sm-10">
                            	<h4>Question:  <span><?php echo $question['quesNo']; ?> / <?php echo $total; ?></span></h4>
                            </div><!--/.col-xs-6-->
                            
                            <div class="col-sm-6 txt-sm-right">
                            
                            	<h4>Time Left:  <span id="time"></span> Minutes</h4>
                            </div><!--/.col-xs-6-->
      ...
      <div class="tab-content">
          ...
          <div class="tab-pane" id="tab1">
            ...
            <div class="wiztab-inner">
                ...
                <h4 class="question-body">Q: <?php echo $question['quesNo']; ?> <?php echo $question['que']; ?></h4>
          ...
          <ul class="pager wizard">
              ...
              <li>
              	...
              	<input type="hidden" name="number" value="<?php echo $number;?>" class="next btn btn-blue pull-right"/>
    ...
    <script src="js/custom-development.js"></script>
     <script src="js/sweetalert.min.js"></script>
      <script>
		...
		{
			//alert('asdkjh');
			swal("Warning!", "You have last 20 seconds left!", "warning");
			return false;
