...
class User
{
	...
	public function userRegistration($email)
	{
		...
		else if(filter_var($mail, FILTER_VALIDATE_EMAIL) === false)
		{
			...
			if($chkResult != false)
			{
				...
				$query = "INSERT INTO tbl_user(userName, userPass, userEmail, userStatus) VALUES('', '$pass', '$mail', '1')";
				//echo $query;exit;
	...
	private function sendMail($mail, $password)
	{
		...
		$to = $mail;
		$subject = "Account Details of".$mail;
		...
		<p>Thank you. We wish you good luck for your exam.</p>
		</body>
		</html>
		";
